...
export function Logo(props) {
  return (
    <div>
      <img width="140" height="29" src="/images/logo.png" className="block dark:hidden" alt="Logo" />
      <img width="140" height="29" src="/images/logo-dark.png" className="hidden dark:block" alt="Logo" />
    </div>
